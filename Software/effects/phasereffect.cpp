...
void PhaserEffect::Init(float sampleRate) {
    ...
    auto* rateParam = new ValueParameter("K3 Rate", 0.02f, 4.0f, 0.3f);
    ...
    AddParameter(new ValueParameter("Center Hz", 150.0f, 1200.0f, 450.0f));

    auto* stagesParam = new IntegerParameter("E1 Stages", 2, 8, 4);
    stagesParam->BindEncoder(ENCODER_1_IDX);
